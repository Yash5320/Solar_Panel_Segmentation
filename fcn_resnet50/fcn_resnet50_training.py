# -*- coding: utf-8 -*-
"""FCN-ResNet50 Training Script

Standalone training script for FCN-ResNet50 model.
"""
...
# import subprocess
# subprocess.run(["pip", "-q", "install", "segmentation-models-pytorch==0.3.3", "torchmetrics==1.4.0", "albumentations==1.4.4", "opencv-python==4.10.0.84"])
...
def build_model(model_name: str, num_classes: int = 2):
    ...
    if model_name == "fcn_resnet50":
        ...
        raise ValueError("model_name must be 'fcn_resnet50'")
